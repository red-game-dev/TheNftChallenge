...
interface FavouriteButtonArgs {
  active?: boolean;
}

const NftCard = styled.li(() => [
  tw`w-full h-full md:w-1/2 xl:w-1/2 px-4 py-5 shadow`
]);

const NftCardBackground = styled.div(() => [
...
const FavouriteButton = styled.span(({ active = false }: FavouriteButtonArgs) => [
